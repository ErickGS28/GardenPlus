...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1b676b] text-white py-8 mt-auto" data-component-name="Footer">
      <div className="container mx-auto px-4" data-component-name="Footer">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div className="mb-8 md:mb-0 px-4">
            <h3 className="text-xl font-semibold mb-4 text-[#bef202]">Enlaces Rápidos</h3>
            <ul className="space-y-2">
              <li><Link to="/" className="hover:text-[#bef202] transition-all duration-300 hover:scale-105 inline-block">Inicio</Link></li>
              <li><Link to="/services" className="hover:text-[#bef202] transition-all duration-300 hover:scale-105 inline-block">Servicios</Link></li>
              <li><Link to="/blog" className="hover:text-[#bef202] transition-all duration-300 hover:scale-105 inline-block">Blog</Link></li>
              <li><Link to="/about" className="hover:text-[#bef202] transition-all duration-300 hover:scale-105 inline-block">Nosotros</Link></li>
            </ul>
          </div>
          <div className="px-4">
